...
(function($) {
	...
	var standard_attach_window_event_handler = MVC.Controller.Action.Event.prototype.attach_window_event_handler;
	...
	MVC.Controller.Action.Event.prototype.attach_window_event_handler = function(event_type) {
		...
		var self = this;
		MVC.Controller.Action.Loaded.callbacks.load.push(
			function(event) { 
				self.callback($(window), event);
			});
	};
